...
var grammar = {
    ...
    {"name": "setElemPred$subexpression$1", "symbols": ["variable"]},
    {"name": "setElemPred$subexpression$1", "symbols": ["number"]},
    {"name": "setElemPred$subexpression$1", "symbols": ["mathExp"]},
    {"name": "setElemPred", "symbols": ["setElemPred$subexpression$1", "setElemOp", "setExp"], "postprocess": (data) => ({ type: "setElemOp", left: data[0], op: data[1][0].value, right: data[2] })},
